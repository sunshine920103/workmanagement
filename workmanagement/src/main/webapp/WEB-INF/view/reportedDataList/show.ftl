			...
			<#else>
				<caption class="titleFont1 titleFont1Ex">报送失败</caption>
					...
					<tr>
						...
						<td class="secondTD"><a class="changeFont fontSize12" href="${request.getContextPath()}/admin/reportedDelete/down.jhtml?reportIndexId=${reportIndex.REPORT_INDEX_ID}&reportIndexName=${reportIndex.REPORT_INDEX_TEMPLATE}&menuName=已报数据">下 载</a></td>
					</tr>
					<tr>
						...
						<td class="secondTD">
							...
							<#elseif reportIndex.REPORT_INDEX_STATUS = 2>
								<span class="changeFont fontSize12">已删除</span>
							</#if>
						</td>
					</tr>
					<tr>
