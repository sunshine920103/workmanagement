	...
	<body>
		...
		<div class="showListBox">
			...
			<form id="form" action="${request.getContextPath()}/admin/sysClassFy/save.jhtml" method="post">
				<input name="sysIndustryId" type="hidden" value="${sysClassFy.sysIndustryId}"/>
				<table cellpadding="0" cellspacing="0">
						<caption class="titleFont1 titleFont1Ex">修改行业分类</caption>
				
					<tr>
						<td class="noBorderL firstTD" width="200"><label class="mainOrange"> * </label>行业类别名称</td>
						<td class="secondTD" width="400">
							<input id="sysIndustryName" name="sysIndustryName" class="inputSty required" value="${sysClassFy.sysIndustryName}" onblur="onblurVal(this,20,30)" title="必填，不能超过30个字" maxlength="30"/>
						</td>
					</tr>
					<tr>
						<td class="noBorderL firstTD"><label class="mainOrange"> * </label>行业类别代码</td>
						<td class="secondTD">
							<input id="sysIndustryCode"  name="sysIndustryCode" class="inputSty required" value="${sysClassFy.sysIndustryCode}" onblur="onblurVal(this,21,20)" title="必填，不能超过20个字" maxlength="20"></input>
						</td>
					</tr>
					<tr>
						<td class="noBorderL firstTD">备注</td>
						<td class="secondTD">
							<textarea name="sysIndustryNotes" class="fontSize12 textareaSty" style="border:1px solid #dadada;" onblur="onblurVal(this,14,50)"  maxlength="50">${sysClassFy.sysIndustryNotes}</textarea>
						</td>
					</tr>
				</table>
