...
<body>
<form id="searchForm" method="post" action="${request.getContextPath()}/admin/reportIndex/sysQuery.jhtml">
</form>
                ...
                <tr>
                    ...
                    <td>
                        <a class="changeFont fontSize12 hasUnderline cursorPointer"
                           onclick="setLayer('查看','${request.getContextPath()}/admin/reportIndex/show.jhtml?reportIndexId=${item.REPORT_INDEX_ID}');$('.layui-layer-shade').height($(window).height());"
                        >查 看</a>
                    </td>
                </tr>
            </#list>
