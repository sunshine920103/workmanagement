...
<html>
	...
	function openArea(obj, id){
			...
			function exportExcel(id){
				window.location.href = "${request.getContextPath()}/admin/sysArea/exportArea.jhtml?id=" + id ;
			}
	...
	<input type="hidden" id="err" value="<#if errorList??>${errorList?size}</#if>">
		<div class="queryInputBox">
			<div class="verticalMiddle">
				...
				<input type="button" value="全部导出" class="sureBtn" onclick="exportExcel(${area.sysAreaId})"/>
			</div>
			<div class="search">
