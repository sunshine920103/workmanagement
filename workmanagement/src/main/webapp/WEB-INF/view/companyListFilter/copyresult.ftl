    ...
    <div class="queryResult showListBox">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            <tbody id="trPanel">
            	<tr>
	                <td width="100">序号</td>
	                <td width="200"><div class="positionR"><span class="sort positionA fontSize12" style="top: -15px;">▲</span><span class="positionA fontSize12" style="top: -3px;">▼</span></div>统一社会信用代码</td>
	                <td width="200"><div class="positionR"><span class="sort positionA fontSize12" style="top: -15px;">▲</span><span class="positionA fontSize12" style="top: -3px;">▼</span></div>组织机构代码</td>
            ...
            <#list defaultIndexItemCustomList as item>
            	<tr>
            		...
            		<td class="redFlagOrg">${item.codeOrg}</td>
            		<td>${item.qymc}</td>
            		<!--<td>${item.lxdh}</td>
            		<td>${item.fddbr}</td>-->
            	</tr>
