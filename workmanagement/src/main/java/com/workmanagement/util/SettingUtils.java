...
public class SettingUtils {
	...
	public static String FILE_PAYCONFIG_MPLUS = "/payConfig.properties";
	...
	/**
	 * 读取payConfig.properties文件中的值
	 * @param key
	 * @return
	 */
	public static String getPayConfigMPlus(String key) {
		Properties prop = loadSetting(FILE_PAYCONFIG_MPLUS);
		return prop.getProperty(key);
	}
